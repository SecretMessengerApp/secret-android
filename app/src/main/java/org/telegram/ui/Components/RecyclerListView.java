...
//        }
    ...
    private class FastScroll extends View {
        ...
        public FastScroll(Context context) {
            ...
            scrollX =  AndroidUtilities.dp(10);
            updateColors();
        }
...
//            invalidate();
    ...
    public RecyclerListView(Context context) {
        ...
        selectorDrawable=new ColorDrawable(Color.WHITE);
...
//        selectorDrawable.setCallback(this);
    ...
    private void highlightRowInternal(RecyclerListView.IntReturnCallback callback, boolean canHighlightLater) {
        ...
        if (holder != null) {
            ...
            AndroidUtilities.runOnUIThread(removeHighlighSelectionRunnable = new Runnable() {
                @Override
                public void run() {
                    removeHighlighSelectionRunnable = null;
