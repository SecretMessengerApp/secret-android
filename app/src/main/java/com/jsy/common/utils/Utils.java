...
public final class Utils {
    ...
    public static double parseDouble(String text, double defWhenException) {
        try {
            if (TextUtils.isEmpty(text) || ".".equals(text)) {
                return defWhenException;
            }
    ...
    public static Drawable createDrawableBounds(Context context, int resIconId) {
        Drawable drawable = ContextCompat.getDrawable(context, resIconId);
