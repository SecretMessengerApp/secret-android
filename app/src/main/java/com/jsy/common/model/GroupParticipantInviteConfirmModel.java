...
public class GroupParticipantInviteConfirmModel implements Serializable {
    ...
    public static GroupParticipantInviteConfirmModel initByConversationData(ConversationData conversationData) {
        ...
        groupParticipantInviteConfirmModel.msgType = MessageUtils.MessageContentUtils.GROUP_PARTICIPANT_INVITE;
        ...
        participantInviteConfirmMsgData.name = UtilForJava.getNameByConversationData(conversationData);
        participantInviteConfirmMsgData.asset = UtilForJava.getSmallRAssetId(conversationData, "");
        participantInviteConfirmMsgData.memberCount = UtilForJava.getConversationMemsum(conversationData);
        groupParticipantInviteConfirmModel.msgData = participantInviteConfirmMsgData;
        return groupParticipantInviteConfirmModel;
    }

    public static GroupParticipantInviteConfirmModel parseJson(String messgeContentString) {
        return new Gson().fromJson(messgeContentString, GroupParticipantInviteConfirmModel.class);
    }
}
